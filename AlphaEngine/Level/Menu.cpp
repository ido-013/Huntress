...
void level::Menu::Init() {
    ...
    CtrUI.InitControlUI();
    // 자막 추가
    SubtitleComp::AddSubtitle({ {-0.2f,-0.27f}, 1, "START", 0, 0, 0, 1 });
    SubtitleComp::AddSubtitle({ {-0.2f,-0.495f}, 1, "Control", 0, 0, 0, 1 });
    SubtitleComp::AddSubtitle({ {-0.2f,-0.72f}, 1, "EXIT", 0, 0, 0, 1 });
}
